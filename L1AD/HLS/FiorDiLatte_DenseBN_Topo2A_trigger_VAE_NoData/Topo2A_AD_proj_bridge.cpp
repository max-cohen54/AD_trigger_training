...
void allocate_trace_storage(size_t element_size) {
    ...
    nnet::trace_outputs->insert(std::pair<std::string, void *>("dense2", (void *) malloc(N_LAYER_5 * element_size)));
    nnet::trace_outputs->insert(std::pair<std::string, void *>("dense2_linear", (void *) malloc(N_LAYER_5 * element_size)));
    nnet::trace_outputs->insert(std::pair<std::string, void *>("relu2", (void *) malloc(N_LAYER_5 * element_size)));
    nnet::trace_outputs->insert(std::pair<std::string, void *>("z_mean", (void *) malloc(N_LAYER_8 * element_size)));
    nnet::trace_outputs->insert(std::pair<std::string, void *>("z_mean_linear", (void *) malloc(N_LAYER_8 * element_size)));
}
