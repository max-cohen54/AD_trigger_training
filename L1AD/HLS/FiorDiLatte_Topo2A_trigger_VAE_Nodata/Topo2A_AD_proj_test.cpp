...
int main(int argc, char **argv) {
    ...
    std::ifstream fin("tb_data/raw_data/Topo_2A_HHbbtt_pure.dat");
    // load predictions from text file
    std::ifstream fpr("tb_data/raw_predictions/Topo_2A_HHbbtt_pure_prediction.dat");

#ifdef RTL_SIM
    std::string RESULTS_LOG = "tb_data/Topo_2A_HHbbtt_pure_rtlsim.log";
#else
    std::string RESULTS_LOG = "tb_data/Topo_2A_HHbbtt_pure_csim.log";
#endif
